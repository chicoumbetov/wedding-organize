...
import {statusSelector, usersSelector} from "../../store/selectors";
                    ...
                    return(
                            React.Children.toArray(
                                <Row lg={12} style={{ display: 'flex'}}>
                                    <Col lg={6} style={{ flex: '1', marginRight: "50px"}}>{user.username}</Col>
                                    <Col lg={6} style={{ flex: '1', marginRight: "50px"}}>{user.email}</Col>
                                    <Col lg={6} style={{ flex: '1' }}>{user.isAdmin ? "Admin" : "Not admin"}</Col>
                                </Row>
                            )
                        )
                })
